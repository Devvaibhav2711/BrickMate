    ...
    return (
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent side="bottom" className="rounded-t-3xl h-[85vh] overflow-y-auto">
                <SheetHeader>
                    <SheetTitle className="text-left">{t('addLabour')}</SheetTitle>
                </SheetHeader>
                <form onSubmit={handleSubmit} className="space-y-4 mt-6">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2 col-span-2">
                            <Label htmlFor="name">{t('labourName')} *</Label>
                            <Input
                                id="name"
                                value={formData.name}
                    ...
                    {/* Professional Fields */}
                    <div className="space-y-2">
                        <Label htmlFor="adhar">{t('adharNo')}</Label>
                        <Input
                            id="adhar"
                    ...
                    <div className="space-y-2">
                        ...
                        <Textarea
                            ...
                            className={`min-h-[60px] ${errors.address ? "border-destructive" : ""}`}
                        />
                    </div>
